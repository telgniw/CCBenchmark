...
plot(t2, color='g')
ymin, ymax = ylim()
text(0, ymax-1, '%s ~ %s' % (st_time, ed_time))
text(0, ymax-2, '%2s: max=%f, min=%f, avg=%f' % stat_tuple('t1', t1), color='r')
text(0, ymax-3, '%2s: max=%f, min=%f, avg=%f' % stat_tuple('t2', t2), color='g')
